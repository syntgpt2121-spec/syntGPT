...
export default function VerifyLogin() {
  ...
  const expectedCode = sessionStorage.getItem("pendingLoginCode") || "";
  ...
  const handleVerify = (e: FormEvent) => {
    ...
    sessionStorage.removeItem("pendingLoginCode");
    ...
    <div className="min-h-screen bg-[#212121] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8 form-slide-in">
          ...
          <p className="text-gray-400 text-sm mt-1">Giriş doğrulama kodunu girin</p>
        </div>
